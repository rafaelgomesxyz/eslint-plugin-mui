...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      recommended: false,
      url: 'https://github.com/rkristelijn/eslint-plugin-mui/tree/main/docs/rules/sort-sx-keys.md',
    },
    schema: [
      {
    ...
    messages: {
      sortSxKeys: "Expected object keys to be in order. '{{thisName}}' should be before '{{prevName}}'.",
    },
  },
